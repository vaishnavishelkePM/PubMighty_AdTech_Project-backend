...
var _arguments = _interopRequireDefault(require("./type/arguments.js"));
var _function = _interopRequireDefault(require("./type/function.js"));
var _emptyFunction = _interopRequireDefault(require("./empty-function.js"));
...
function isEmpty(value) {
  ...
  if (className === arrayClass || className === stringClass || (support.argsClass ? className === argsClass : (0, _arguments.default)(value)) || className === objectClass && typeof length === 'number' && (0, _function.default)(value.splice)) {
    return !length;
  }
  if (className === funcClass) {
    return (0, _emptyFunction.default)(value);
  }
  if (getOwnPropertyNames(value).length > 0) {
    return false;
  }
  /*

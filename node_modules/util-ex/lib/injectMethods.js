...
var _injectMethod = _interopRequireDefault(require("./injectMethod.js"));
 ...
 */
function injectMethods(aObject, aMethods, aOptions) {
  let replacedMethods;
  ...
  if (aMethods instanceof Object) {
    ...
    for (const k in aMethods) {
      const v = aMethods[k];
      if (!(0, _function.default)(v)) {
        continue;
      }
      const inherited = aObject[k];
      if ((0, _function.default)(inherited) && !(replacedMethods && replacedMethods[k])) {
        results.push((0, _injectMethod.default)(aObject, k, v));
      } else {
 ...
 */
var _default = exports.default = injectMethods;
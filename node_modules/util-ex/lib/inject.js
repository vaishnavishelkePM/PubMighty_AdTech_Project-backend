...
var _defineProperty = _interopRequireDefault(require("inherits-ex/lib/defineProperty"));
var _arguments = _interopRequireDefault(require("./is/type/arguments.js"));
 ...
 *
 */
function inject(aOrgFunc, aBeforeExec, aAfterExec) {
  return function () {
    let Result;
    let isDenied = false;
...
function isArguments(v) {
  return v && v.__arguments__ || (0, _arguments.default)(v);
}
